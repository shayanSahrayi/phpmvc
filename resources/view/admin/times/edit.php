...
<div class="row d-flex justify-content-evenly">
    <div class="col-12 dashboard-box bg-white text-black">
        ...
        <form class="row g-3 mt-2" method="post" id="formUpdate" action="<?= url("admin/times/update/$time->id") ?>">
            ...
            <div class="col-md-6">
                ...
                <input type="time" class="form-control bg-white" name="start_time" value="<?= $time->start_time ?>">
            </div>


            <div class="col-md-6">
                <label for="end_time" class="form-label">ساعت پایان</label>
                <input type="time" name="end_time" class="form-control" value="<?= $time->end_time ?>" id="end_time">
            </div>

            <div class="col-md-6">
                <label for="capacity" class="form-label">ظرفیت</label>
                <input type="number" name="capacity" value="<?= $time->capacity ?>" class="form-control" id="capacity">
            </div>
            <div class="col-md-6">
            <label for="" class="form-label">جنسیت :</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="gender" <?=$time->gender==1 ?'checked':''?> id="inlineRadio1" value="1">
                    <label class="form-check-label" for="inlineRadio1">مردان</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="gender" <?=$time->gender==2 ?'checked':''?> id="inlineRadio2" value="2">
            ...
            <div class="col-md-6">
                ...
                <select name="status" id="status" class="form-control">
                    <option value="10" <?= $time->status == 10 ? 'selected' : '' ?>>دوره فعال</option>
                    <option value="0" <?= $time->status == 0 ? 'selected' : '' ?>>دوره غیر فعال</option>
                </select>
            </div>
